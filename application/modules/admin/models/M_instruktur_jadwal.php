...
class M_instruktur_jadwal extends CI_Model
{
    ...
    function ketersediaan($data,$id_update=''){
        $query = "SELECT count(*) c FROM instruktur_jadwal WHERE ji_tgl='".$data['ji_tgl']."' AND ((ji_jam_mulai <= '".$data['ji_jam_mulai']."' AND ji_jam_selesai > '".$data['ji_jam_mulai']."') OR (ji_jam_mulai < '".$data['ji_jam_selesai']."' AND ji_jam_selesai >= '".$data['ji_jam_selesai']."')) ";
        if (!empty($id_update)){
