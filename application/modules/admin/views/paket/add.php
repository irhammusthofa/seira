                ...
                <div class="box-body">
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php echo form_dropdown('anggota',$data['anggota'],'',array('class'=>'form-control select2','required'=>'true')) ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-6 control-label">Kategori <b style="color:red">*</b></label>
                            <div class="col-sm-6">
                                <?php echo form_dropdown('kategori',$data['kategori'],'',array('class'=>'form-control select2','required'=>'true')) ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <!-- <div class="form-group">
                            <label class="col-sm-6 control-label">Biaya Paket <b style="color:red">*</b></label>
                            <div class="col-sm-6">
                                <input id="biaya" name="biaya" type="number" class="form-control" placeholder="Biaya Paket" required>
                            </div>
                        </div> -->
                    </div>
                </div>
