                ...
                <div class="box-body">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php echo form_dropdown('anggota',$data['anggota'],$data['paket']->id_anggota,array('class'=>'form-control  select2','required'=>'true')) ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-6 control-label">Kategori <b style="color:red">*</b></label>
                            <div class="col-sm-6">
                                <?php echo form_dropdown('kategori',$data['kategori'],$data['paket']->id_kategori,array('class'=>'form-control  select2','required'=>'true')) ?>
                            </div>
                        </div>
                        <div class="form-group">
