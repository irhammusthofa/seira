    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <?= form_open('admin/ruangan/simpan/',array('method'=>'post','class'=>'form-horizontal')) ?>
                <div class="box-body">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label class="col-sm-6 control-label">Nama Ruangan <b style="color:red">*</b></label>
                            <div class="col-sm-6">
                                <input id="ruangan" name="ruangan" type="text" class="form-control" placeholder="Nama Ruangan"
                                    required>
                            </div>
                        </div>
                    </div>
