    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <?= form_open('admin/instruktur/kategori/simpan/'.base64_encode($data['instruktur']->i_kode),array('method'=>'post','class'=>'form-horizontal')) ?>
                <div class="box-body">
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php 
                                    echo form_dropdown('kategori',$data['kategori'],'',array('class'=>'form-control','required'=>'true')) ?>
                            </div>
                        </div>
                        <div class="form-group">
