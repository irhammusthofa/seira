...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url() ?>" class="logo">
      ...
      <span class="logo-mini"><b>S</b>Instruktur</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SEIRA</b>Instruktur</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left" hidden>
                  <?= anchor('instruktur/profile','Profile',array('class'=>'btn btn-default btn-flat')) ?>
                </div>
                <div class="pull-right">
                  <?= anchor('logout/'.base64_encode('instruktur'),'Logout',array('class'=>'btn btn-default btn-flat')) ?>
                </div>
              </li>
            </ul>
          </li>
