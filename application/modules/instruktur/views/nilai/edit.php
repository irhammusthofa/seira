    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <?= form_open('instruktur/nilai/simpan/'.base64_encode($data['id_kategori']).'/'.base64_encode($data['id_paket']),array('method'=>'post','class'=>'form-horizontal')) ?>
                <div class="box-body">
                    <div class="col-md-12">
                                        ...
                                        for($i=0;$i<=9;$i++){
                                            if ($i==0){
                                                ...
                                                if ($nilai['status'] == false){
                                                    ...
                                                    echo '<td width="60px">';
                                                    echo '<input type="text" class="form-control" name="'.$item->kr_id.$i.'" value="'.$nilai['value'].'" style="width:60px;text-align:center;vertical-align:middle"/>';
                                                    echo '</td>';
                                                    $skor[$i] += $nilai['value'];
                                                    $srow[$i] += $nilai['value'];
                                                }
                                    ...
                                    for($i=0;$i<=9;$i++){
                                        ...
                                        if ($i==0){
                                            ...
                                            if ($nilai['status'] == false){
                                                ...
                                                echo '<input type="checkbox" name="abs'.$i.'" value="1" '.$checked.'/>';
                                                echo '</th>';
                ...
                <div class="box-footer">
                    <div class="pull-right">
                        <?= anchor('instruktur/nilai/','Batal', array('class'=>'btn btn-default')) ?> &nbsp;
