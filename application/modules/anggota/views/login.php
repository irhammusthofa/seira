...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url('anggota/auth/login') ?>"><b>Login</b> SEIRA</a>
  </div>
    <?php fs_show_alert() ?>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Masukan username dan password anda.</p>
    <?= form_open('anggota/auth/dologin',array('method'=>'post')) ?>
      ...
      <div class="row">
        ...
        <div class="col-xs-4 pull-right">
          <?= anchor('anggota/signup','Daftar',array('class'=>'btn btn-success btn-block btn-flat')) ?>
        </div>
        <!-- /.col -->
      </div>
    <?= form_close() ?>
