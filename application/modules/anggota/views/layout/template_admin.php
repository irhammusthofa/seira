...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url() ?>" class="logo">
      ...
      <span class="logo-mini"><b>S</b>Anggota</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SEIRA</b>Anggota</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left" hidden>
                  <?= anchor('anggota/profile','Profile',array('class'=>'btn btn-default btn-flat')) ?>
                </div>
                <div class="pull-right">
                  <?= anchor('logout/'.base64_encode(base_url()),'Logout',array('class'=>'btn btn-default btn-flat')) ?>
                </div>
              </li>
            </ul>
          </li>
